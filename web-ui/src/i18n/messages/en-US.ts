...
const enUS = {
  ...
  actions: {
    title: 'Actions',
    description: 'Review automated first-message attempts and order candidates. This page only shows restricted automation and never auto-pays.',
    empty: 'No action records yet. They will appear here after a recommended item triggers the action engine.',
    filters: {
      task: 'Task Filter',
      allTasks: 'All Tasks',
  ...
  settings: {
    ...
    prompts: {
      ...
      create: 'New Prompt',
      createConfirm: 'Create File',
      createDialogTitle: 'Create Prompt File',
      createDialogDescription: 'Create a new .txt prompt file and load it into the editor immediately.',
      selectFile: 'Select Prompt File',
      placeholder: 'Select a prompt file...',
      none: 'No prompt files found.',
      filename: 'Filename',
      filenameRequired: 'Please enter a prompt filename.',
      initialContent: 'Initial Content',
      initialContentPlaceholder: 'Optional. Leave empty to create a blank prompt file.',
