...
const zhCN = {
  ...
  actions: {
    title: '动作记录',
    description: '查看自动首句沟通与候选下单动作的执行结果。这里只展示受限自动化，不包含自动支付。',
    empty: '暂无动作记录。运行命中推荐的任务后会出现在这里。',
    filters: {
      task: '任务筛选',
      allTasks: '全部任务',
      status: '状态筛选',
  ...
  settings: {
    ...
    prompts: {
      ...
      create: '新建 Prompt',
      createConfirm: '创建文件',
      createDialogTitle: '新建 Prompt 文件',
      createDialogDescription: '创建一个新的 .txt Prompt 文件，创建后会自动载入到编辑器中。',
      selectFile: '选择 Prompt 文件',
      placeholder: '请选择一个 Prompt 文件...',
      none: '没有找到 Prompt 文件。',
      filename: '文件名',
      filenameRequired: '请输入 Prompt 文件名',
      initialContent: '初始内容',
      initialContentPlaceholder: '可选。留空则创建空 Prompt 文件。',
      content: 'Prompt 内容',
      contentPlaceholder: '请选择一个 Prompt 文件进行编辑...',
      save: '保存更改',
      createSuccess: 'Prompt 创建成功',
      createFailed: 'Prompt 创建失败',
