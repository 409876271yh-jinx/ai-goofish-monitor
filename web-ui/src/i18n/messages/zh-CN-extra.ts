  ...
  tasks: {
    ...
    form: {
      ...
      actionEngine: {
        ...
        primaryAction: '命中后动作',
        messageTemplate: '首句模板',
        messageTemplateHint: '只允许从白名单模板中选择。若选择“按商品自动判断”，系统会按商品信息自动挑选模板。',
        primaryActions: {
          auto: '自动判断',
          sendMessage: '自动联系卖家',
          orderCandidate: '生成候选单',
        },
        primaryActionHints: {
          auto: '高分且低风险商品优先生成候选单，其余商品尝试自动发送首句。',
          sendMessage: '命中后优先自动联系卖家，最多只发一条白名单首句。',
          orderCandidate: '命中后只生成候选下单记录并通知人工确认，不自动付款。',
        },
        templates: {
          auto: '按商品自动判断',
          askLowestPrice: '我想要你这个商品最低价多钱？',
          askAvailability: '你好，请问这个还在吗？',
          askCondition: '你好，请问成色和是否有维修/暗病方便描述一下吗？',
          askBattery: '你好，请问电池健康/续航情况怎么样？',
        },
        minAiScore: '最低 AI 分数',
        cooldownSeconds: '卖家冷却时间（秒）',
        orderCandidateScore: '候选下单阈值',
        riskWords: '风险词过滤',
        riskWordsPlaceholder: '每行一个风险词，例如：私聊微信\n先付定金\n线下交易',
        riskWordsHint: '命中这些词会直接跳过动作执行。不会自动支付，不会绕过验证码或风控。',
      },
      priceRange: '价格范围',
      minPrice: '最低价',
      maxPrice: '最高价',
