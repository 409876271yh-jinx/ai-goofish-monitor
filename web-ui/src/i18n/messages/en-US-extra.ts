  ...
  tasks: {
    ...
    form: {
      ...
      actionEngine: {
        ...
        messageTemplate: 'First-message Template',
        messageTemplateHint: 'Only whitelisted templates are allowed. If you choose auto, the system will pick a template from item signals.',
        primaryActions: {
          auto: 'Auto Decide',
          sendMessage: 'Auto Message Seller',
          orderCandidate: 'Create Order Candidate',
        },
        primaryActionHints: {
          auto: 'High-score, low-risk items become order candidates first; the rest try a single first message.',
          sendMessage: 'Recommended items try one whitelisted first message before anything else.',
          orderCandidate: 'Recommended items only create candidate records and notify a human for review, with no auto-payment.',
        },
        templates: {
          auto: 'Auto by Item',
          askLowestPrice: 'I want this item, what is your lowest price?',
          askAvailability: 'Hi, is this still available?',
          askCondition: 'Hi, could you describe the condition and whether there were any repairs or hidden issues?',
          askBattery: 'Hi, how is the battery health and battery life?',
        },
        minAiScore: 'Minimum AI Score',
        cooldownSeconds: 'Seller Cooldown (seconds)',
        orderCandidateScore: 'Order Candidate Threshold',
        riskWords: 'Risk Word Filter',
        riskWordsPlaceholder: 'One risk phrase per line, e.g. private WeChat\npay deposit first\noff-platform deal',
        riskWordsHint: 'Matching these words skips the action entirely. No auto-payment and no captcha or risk-control bypassing.',
      },
