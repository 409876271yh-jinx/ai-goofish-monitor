    ...
    for index, raw_task in enumerate(tasks):
        ...
        conn.execute(
            ...
            (
                ...
                json.dumps(raw_task.get("action_settings") or {}, ensure_ascii=False),
                _as_int(raw_task.get("enable_structured_prefilter", False)),
                json.dumps(raw_task.get("vehicle_filter") or {}, ensure_ascii=False),
