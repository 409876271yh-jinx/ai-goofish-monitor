...
SCHEMA_STATEMENTS = (
    ...
    """,
    """
    CREATE INDEX IF NOT EXISTS idx_actions_item_type
    ON actions(item_id, action_type, created_at DESC)
    """,
    """
    CREATE INDEX IF NOT EXISTS idx_actions_seller_type_status
    ON actions(seller_id, action_type, status, created_at DESC)
    """,
)
